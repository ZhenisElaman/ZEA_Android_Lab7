...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://wbx-content-v2.wbstatic.net/price-history/116547820.json"; // Адрес получения JSON - данных
        ...
        if (json != null) {
            try {
                ...
                for (int i = 0; i < array.length(); i ++) {
                    ...
                    String dt = array1.getString("dt");

                    System.out.println("///" + dt);
                    JSONObject price = array1.getJSONObject("price");

                    String RUB = price.getString("RUB");

                    System.out.println("+++" + RUB);

                    textView.append("Товар по номеру: " + dt + "\n" + "Стоймость: " + RUB + " " + "RUB");
                    textView.append("\n");
                }
            } catch (Exception e) {
